...
class TrustPaymentsWebhookModuleFrontController extends ModuleFrontController
{
    ...
    public function postProcess()
    {
        ...
        $webhookService = TrustPaymentsServiceWebhook::instance();
        ...
        try {
            ...
            $request = new TrustPaymentsWebhookRequest($parsed);
            ...
            PrestaShopLogger::addLog($e->getMessage(), 3, null, 'TrustPaymentsWebhookEntity');
            echo $e->getMessage();
            die();
        }
    }
