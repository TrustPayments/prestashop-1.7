...
class TrustPaymentsReturnModuleFrontController extends ModuleFrontController
{
    public $ssl = true;
    ...
    public function postProcess()
    {
        ...
        if ($orderId != null) {
            ...
            if ($orderKey == null || $orderKey != TrustPaymentsHelper::computeOrderSecret($order)) {
    ...
    {
        $transactionService = TrustPaymentsServiceTransaction::instance();
    ...
    private function processFailure(Order $order)
    {
        ...
        $transaction = TrustPaymentsModelTransactioninfo::loadByOrderId($order->id);
        ...
        if (empty($userFailureMessage)) {
            ...
            if ($failureReason !== null) {
                $userFailureMessage = TrustPaymentsHelper::translate($failureReason);
            }
        }
        if (! empty($userFailureMessage)) {
            $this->context->cookie->tru_error = $userFailureMessage;
        }
