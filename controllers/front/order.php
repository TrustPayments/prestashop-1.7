...
class TrustPaymentsOrderModuleFrontController extends ModuleFrontController
{
    public $ssl = true;
    ...
    public function postProcess()
    {
        ...
        try {
            ...
            $noIframeParamater = Tools::getValue('trustpayments-iframe-possible-' . $methodId, null);
    ...
    protected function checkAvailablility(Cart $cart)
    {
        if ($cart->id_address_delivery == 0 || $cart->id_address_invoice == 0 || ! $this->module->active ||
            ...
            $this->context->cookie->tru_error = $this->module->l('Your session expired, please try again.', 'order');
