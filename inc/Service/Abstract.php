 ...
 */
abstract class TrustPaymentsServiceAbstract
{
    ...
    {
        return TrustPaymentsHelper::getCurrencyFractionDigits($currencyCode);
    }
    ...
    {
        return TrustPaymentsHelper::roundAmount($amount, $currencyCode);
    }
