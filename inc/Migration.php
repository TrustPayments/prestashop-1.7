...
class TrustPaymentsMigration extends TrustPaymentsAbstractmigration
{
    ...
    public static function addCronJob()
    {
        ...
        $moduleInstance = TrustPaymentsHelper::getModuleInstance();
        $moduleInstance->registerHook('trustPaymentsCron');
        ...
        if (!Tab::getIdFromClassName('AdminTrustPaymentsCronJobs')) {
            TrustPaymentsBasemodule::addTab($moduleInstance, 'AdminTrustPaymentsCronJobs', $controllers['AdminTrustPaymentsCronJobs']['name'], $controllers['AdminTrustPaymentsCronJobs']['parentId']);
        }
    }
}
