...
abstract class TrustPaymentsAbstractmigration
{
    const CK_DB_VERSION = 'TRU_DB_VERSION';
    ...
    public static function installDb()
    {
        try {
            ...
            PrestaShopLogger::addLog($e->getMessage(), 2, null, 'TrustPayments');
            return false;
        }
        return true;
    }
    ...
    protected static function installTableBase()
    {
        ...
        $result = $instance->execute(
            "CREATE TABLE IF NOT EXISTS " . _DB_PREFIX_ . "tru_method_configuration(
        ...
        $result = $instance->execute(
            "CREATE TABLE IF NOT EXISTS " . _DB_PREFIX_ . "tru_transaction_info(
        ...
        $result = $instance->execute(
            "CREATE TABLE IF NOT EXISTS " . _DB_PREFIX_ . "tru_token_info(
        ...
        $result = $instance->execute(
            "CREATE TABLE IF NOT EXISTS " . _DB_PREFIX_ . "tru_cart_meta(
        ...
        $result = $instance->execute(
            "CREATE TABLE IF NOT EXISTS " . _DB_PREFIX_ . "tru_order_meta(
				`order_id` int(10) unsigned NOT NULL,
                `meta_key` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
                `meta_value` longtext COLLATE utf8_unicode_ci NULL,
        ...
        $result = $instance->execute(
            "CREATE TABLE IF NOT EXISTS " . _DB_PREFIX_ . "tru_void_job(
        ...
        $result = $instance->execute(
            "CREATE TABLE IF NOT EXISTS " . _DB_PREFIX_ . "tru_completion_job(
        ...
        $result = $instance->execute(
            "CREATE TABLE IF NOT EXISTS " . _DB_PREFIX_ . "tru_refund_job(
    ...
    {
        $authorizedStatus = TrustPaymentsOrderstatus::getAuthorizedOrderStatus();
        $waitingStatus = TrustPaymentsOrderstatus::getWaitingOrderStatus();
        $manualStatus = TrustPaymentsOrderstatus::getManualOrderStatus();

        Configuration::updateGlobalValue(TrustPaymentsBasemodule::CK_STATUS_FAILED, Configuration::get('PS_OS_ERROR'));
        Configuration::updateGlobalValue(TrustPaymentsBasemodule::CK_STATUS_AUTHORIZED, $authorizedStatus->id);
        Configuration::updateGlobalValue(TrustPaymentsBasemodule::CK_STATUS_VOIDED, Configuration::get(
            'PS_OS_CANCELED'
        ));
        Configuration::updateGlobalValue(TrustPaymentsBasemodule::CK_STATUS_COMPLETED, $waitingStatus->id);
        Configuration::updateGlobalValue(TrustPaymentsBasemodule::CK_STATUS_MANUAL, $manualStatus->id);
        Configuration::updateGlobalValue(
            TrustPaymentsBasemodule::CK_STATUS_DECLINED,
            Configuration::get('PS_OS_CANCELED')
        );
        Configuration::updateGlobalValue(TrustPaymentsBasemodule::CK_STATUS_FULFILL, Configuration::get(
            'PS_OS_PAYMENT'
        ));
    }
    ...
    {
        TrustPaymentsHelper::getModuleInstance()->registerHook('actionObjectOrderPaymentAddBefore');
    }
    ...
    protected static function updateCustomerIdOnTokenInfoBase()
    {
        ...
        $result = $instance->execute(
            ...
            "tru_token_info` CHANGE `customer_id` `customer_id` int(10) unsigned NULL DEFAULT NULL;"
        );
        if ($result === false) {
            throw new Exception($instance->getMsgError());
        }
    ...
    protected static function updateImageBase()
    {
        ...
        $exists = $instance->executeS(
            "SHOW COLUMNS FROM `" . _DB_PREFIX_ . "tru_method_configuration` LIKE 'image_base'"
        );
        if (empty($exists)) {
            $result = $instance->execute(
                "ALTER TABLE `" . _DB_PREFIX_ .
                "tru_method_configuration` ADD COLUMN `image_base` varchar(2047) COLLATE utf8_unicode_ci NULL DEFAULT NULL AFTER image;"
            );
            if ($result === false) {
                throw new Exception($instance->getMsgError());
            }
        ...
        $exists = $instance->executeS("SHOW COLUMNS FROM `" . _DB_PREFIX_ . "tru_transaction_info` LIKE 'image_base'");
        if (empty($exists)) {
            $result = $instance->execute(
                "ALTER TABLE `" . _DB_PREFIX_ .
                "tru_transaction_info` ADD COLUMN `image_base` VARCHAR(2047)  COLLATE utf8_unicode_ci NULL DEFAULT NULL AFTER image;"
            );
            if ($result === false) {
                throw new Exception($instance->getMsgError());
            }
    ...
    protected static function userFailureMessageBase()
    {
        $instance = Db::getInstance();
        $exists = $instance->executeS(
            "SHOW COLUMNS FROM `" . _DB_PREFIX_ . "tru_transaction_info` LIKE 'user_failure_message'"
        );
        if (empty($exists)) {
            $result = $instance->execute(
                "ALTER TABLE `" . _DB_PREFIX_ .
                "tru_transaction_info` ADD COLUMN `user_failure_message` VARCHAR(2047)  COLLATE utf8_unicode_ci NULL DEFAULT NULL AFTER image;"
            );
            if ($result === false) {
                throw new Exception($instance->getMsgError());
            }
