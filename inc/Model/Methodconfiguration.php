...
class TrustPaymentsModelMethodconfiguration extends ObjectModel
{
    ...
    public $fee_base = TrustPaymentsBasemodule::TOTAL_MODE_BOTH_INC;
    ...
    public static $definition = array(
        'table' => 'tru_method_configuration',
    ...
    {
        $this->title = TrustPaymentsTools::base64Encode(serialize($title));
    }

    public function getTitle()
    {
        $decoded = TrustPaymentsTools::base64Decode($this->title, true);
        if ($decoded === false) {
            $decoded = $this->title;
        }
    ...
    {
        $this->description = TrustPaymentsTools::base64Encode(serialize($description));
    }

    public function getDescription()
    {
        $decoded = TrustPaymentsTools::base64Decode($this->description, true);
        if ($decoded === false) {
     ...
     * @param int $id
     * @param int $shopId
     * @return TrustPaymentsModelMethodconfiguration | false
     */
    public static function loadByIdWithChecks($id, $shopId)
    {
        ...
        $collection = new PrestaShopCollection('TrustPaymentsModelMethodconfiguration');
     ...
     * @return TrustPaymentsModelMethodconfiguration[]
     */
    ...
    public static function loadByConfigurationAndShop($spaceId, $configurationId, $shopId)
    {
        ...
        if ($result === false) {
            $result = new TrustPaymentsModelMethodconfiguration();
        }
        return $result;
    }
