...
<div class="panel col-lg-12">	
	<div class="panel-heading">
		...
		Trust Payments {l s='CronJobs' mod='trustpayments'}
	</div>
				...
				<thead>
					<tr class="nodrag nodrop">
						<th class="fixed-width-xs text-center">
							<span class="title_box">{l s='ID' mod='trustpayments'}</span>
						</th>
						<th class="fixed-width-s text-center">
							<span class="title_box">{l s='State' mod='trustpayments'}</span>
						</th>
						<th class="fixed-width-m text-center">
							<span class="title_box">{l s='Scheduled' mod='trustpayments'}</span>
						</th>
						<th class="fixed-width-m text-center">
							<span class="title_box">{l s='Started' mod='trustpayments'}</span>
						</th>
						<th class="fixed-width-m text-center">
							<span class="title_box">{l s='Finished' mod='trustpayments'}</span>
						</th>
						<th class="fixed-width-l center">
							<span class="title_box">{l s='Message' mod='trustpayments'}</span>
						</th>
					</tr>
				...
				{else}
					<tr>
						<td class="text-center" colspan="6">
							{l s='No cron available yet.' mod='trustpayments'}
						</td>
					</tr>
				{/if}
				</tbody>
